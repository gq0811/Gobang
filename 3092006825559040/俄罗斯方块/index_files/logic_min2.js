...
var Game = new function () {
    ...
    function iso(x, y, r, theta) {
        ...
        var v = 30;
        return {
            x: r * Math.cos((2 * Math.PI) * ((x - theta) / 15 - 1 / 4)) * (y + v) / v,
    ...
    var blockData = [{
        ...
        theme: 0,
        frequency: 1,
        coords: [[{x: 1, y: 0}, {x: 2, y: 0}, {x: 1, y: 1}, {x: 2, y: 1}]]
    }, {
        view: 0.25,
        theme: 1,
        frequency: 1,
        coords: [[{x: 0, y: 0}, {x: 1, y: 0}, {x: 2, y: 0}, {x: 3, y: 0}], [{x: 1, y: -1}, {x: 1, y: 0}, {
            x: 1,
            y: 1
        }, {x: 1, y: 2}]]
    }, {
        ...
        theme: 2,
        frequency: 1,
        coords: [[{x: 1, y: 1}, {x: 0, y: 0}, {x: 1, y: 0}, {x: 2, y: 0}], [{x: 1, y: 1}, {x: 2, y: 0}, {
            x: 1,
            y: -1
        }, {x: 1, y: 0}], [{x: 2, y: 0}, {x: 1, y: -1}, {x: 0, y: 0}, {x: 1, y: 0}], [{x: 1, y: 1}, {x: 0, y: 0}, {
            x: 1,
            y: -1
        }, {x: 1, y: 0}]]
    }, {
        ...
        theme: 3,
        frequency: 1,
        coords: [[{x: 0, y: 0}, {x: 1, y: 0}, {x: 2, y: 0}, {x: 0, y: 1}], [{x: 1, y: -1}, {x: 1, y: 0}, {
            x: 1,
            y: 1
        }, {x: 2, y: 1}], [{x: 0, y: 0}, {x: 2, y: 0}, {x: 1, y: 0}, {x: 2, y: -1}], [{x: 1, y: -1}, {
            x: 1,
            y: 0
        }, {x: 1, y: 1}, {x: 0, y: -1}]]
    }, {
        ...
        theme: 4,
        frequency: 1,
        coords: [[{x: 2, y: 0}, {x: 1, y: 0}, {x: 0, y: 0}, {x: 2, y: 1}], [{x: 1, y: -1}, {x: 1, y: 0}, {
            x: 1,
            y: 1
        }, {x: 2, y: -1}], [{x: 0, y: 0}, {x: 1, y: 0}, {x: 2, y: 0}, {x: 0, y: -1}], [{x: 1, y: -1}, {
            x: 1,
            y: 0
        }, {x: 1, y: 1}, {x: 0, y: 1}]]
    }, {
        ...
        theme: 5,
        frequency: 1,
        coords: [[{x: 2, y: 1}, {x: 1, y: 1}, {x: 1, y: 0}, {x: 0, y: 0}], [{x: 1, y: 1}, {x: 1, y: 0}, {
            x: 0,
            y: 2
        }, {x: 0, y: 1}]]
    }, {
        ...
        theme: 6,
        frequency: 1,
        coords: [[{x: 1, y: 1}, {x: 0, y: 1}, {x: 2, y: 0}, {x: 1, y: 0}], [{x: 1, y: 1}, {x: 1, y: 0}, {
            x: 2,
            y: 2
        }, {x: 2, y: 1}]]
    }, {
        ...
        theme: 0,
        frequency: 0.025,
        coords: [[{x: 1, y: 1}, {x: 2, y: 1}, {x: 1, y: 0}, {x: 2, y: 0}, {x: 3, y: 0}], [{x: 1, y: 1}, {
            x: 2,
            y: 1
        }, {x: 1, y: 0}, {x: 2, y: 0}, {x: 1, y: -1}], [{x: 1, y: 1}, {x: 2, y: 1}, {x: 1, y: 0}, {x: 2, y: 0}, {
            x: 2,
            y: -1
        ...
        theme: 7,
        frequency: 0.025,
        coords: [[{x: 1, y: 2}, {x: 0, y: 2}, {x: 2, y: 2}, {x: 1, y: 1}, {x: 1, y: 0}], [{x: 2, y: 2}, {
            x: 1,
            y: 1
        }, {x: 2, y: 1}, {x: 0, y: 1}, {x: 2, y: 0}], [{x: 1, y: 2}, {x: 1, y: 1}, {x: 1, y: 0}, {x: 0, y: 0}, {
            x: 2,
            y: 0
        }], [{x: 0, y: 2}, {x: 1, y: 1}, {x: 0, y: 1}, {x: 2, y: 1}, {x: 0, y: 0}]]
    }, {view: 0.5, theme: 7, frequency: 0.05, coords: [[{x: 1, y: 0}]]}, {
        view: 0.5,
        theme: 7,
        frequency: 0.01,
        coords: [[{x: 1, y: 0}, {x: 0, y: 0}, {x: 14, y: 0}, {x: 2, y: 0}, {x: 13, y: 0}, {x: 3, y: 0}, {
            x: 12,
            y: 0
        }, {x: 4, y: 0}, {x: 11, y: 0}, {x: 5, y: 0}, {x: 10, y: 0}, {x: 6, y: 0}, {x: 9, y: 0}, {x: 7, y: 0}, {
            x: 8,
            y: 0
        }]]
    }];
    ...
    function nextFrame(junk, keyForce) {
        ...
        posY -= Math.max(0, Math.min(1, elapsed / delay));
        lastFrameTime = now;
        if (animating == 1) {
            elapsed = (self.time - animatingStartTime) / Math.sqrt(animatingLines.length);
            if (elapsed > 300 || elapsed < 0) {
                ...
                Game.drawCylinder(false, false, elapsed / 300, animatingLines);
                return;
            }
        }
        if (keyForce || (keysDown.left ^ keysDown.right) && (now - lastMoveTime > 150)) {
            lastMoveTime = now;
            Game.move(keyForce == 'left' ? -1 : keyForce == 'right' ? 1 : keysDown.left ? -1 : keysDown.right ? 1 : 0);
        }
    ...
    function getBlockColor(type, intensity, lightness) {
        ...
        switch (type) {
            case 0:
                return 'rgb(' + ((intensity * 255) >> 0) + ',' + ((intensity * L) >> 0) + ',' + ((intensity * L) >> 0) + ')';
            case 1:
                return 'rgb(' + ((intensity * L) >> 0) + ',' + ((intensity * 255) >> 0) + ',' + ((intensity * L) >> 0) + ')';
            case 2:
                return 'rgb(' + ((intensity * L) >> 0) + ',' + ((intensity * L) >> 0) + ',' + ((intensity * 255) >> 0) + ')';
            case 3:
                return 'rgb(' + ((intensity * 255) >> 0) + ',' + ((intensity * 255) >> 0) + ',' + ((intensity * L) >> 0) + ')';
            case 4:
                return 'rgb(' + ((intensity * 255) >> 0) + ',' + ((intensity * L) >> 0) + ',' + ((intensity * 255) >> 0) + ')';
            case 5:
                return 'rgb(' + ((intensity * L) >> 0) + ',' + ((intensity * 255) >> 0) + ',' + ((intensity * 255) >> 0) + ')';
            case 6:
                return 'rgb(' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ')';
            case 20:
                return 'rgb(' + ((intensity * 100) >> 0) + ',' + ((intensity * 100) >> 0) + ',' + ((intensity * 100) >> 0) + ')';
            case 30:
                return 'rgb(' + ((intensity * 190) >> 0) + ',' + ((intensity * 190) >> 0) + ',' + ((intensity * 0) >> 0) + ')';
            default:
                return 'rgb(' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ')';
        }
        return 'black';
    ...
    this.drawPiece = function () {
        ...
        var intensity = Math.sin(new Date().getTime() / 150) * 0.05 + 0.95;
        ctx.fillStyle = getBlockColor(type, intensity, 140);
        var joinTop;
        var joinBottom;
        var joinLeft;
        var joinRight;
        ...
        for (i = 0; i < 15; i++) {
            ...
            for (y = 0; y < 15; y++) {
                ...
                if (field[xSlot][y]) {
                    ...
                    switch (theme) {
                        case 0:
                            ctx.fillStyle = 'rgb(' + ((intensity * 255) >> 0) + ',' + ((intensity * 0) >> 0) + ',' + ((intensity * 0) >> 0) + ')';
                            break;
                        case 1:
                            ctx.fillStyle = 'rgb(' + ((intensity * 0) >> 0) + ',' + ((intensity * 255) >> 0) + ',' + ((intensity * 0) >> 0) + ')';
                            break;
                        case 2:
                            ctx.fillStyle = 'rgb(' + ((intensity * 0) >> 0) + ',' + ((intensity * 0) >> 0) + ',' + ((intensity * 255) >> 0) + ')';
                            break;
                        case 3:
                            ctx.fillStyle = 'rgb(' + ((intensity * 255) >> 0) + ',' + ((intensity * 255) >> 0) + ',' + ((intensity * 0) >> 0) + ')';
                            break;
                        case 4:
                            ctx.fillStyle = 'rgb(' + ((intensity * 255) >> 0) + ',' + ((intensity * 0) >> 0) + ',' + ((intensity * 255) >> 0) + ')';
                            break;
                        case 5:
                            ctx.fillStyle = 'rgb(' + ((intensity * 0) >> 0) + ',' + ((intensity * 255) >> 0) + ',' + ((intensity * 255) >> 0) + ')';
                            break;
                        case 6:
                            ctx.fillStyle = 'rgb(' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ')';
                            break;
                        case 20:
                            ctx.fillStyle = 'rgb(' + ((intensity * 100) >> 0) + ',' + ((intensity * 100) >> 0) + ',' + ((intensity * 100) >> 0) + ')';
                            break;
                        case 30:
                            ctx.fillStyle = 'rgb(' + ((intensity * 190) >> 0) + ',' + ((intensity * 190) >> 0) + ',' + ((intensity * 0) >> 0) + ')';
                            break;
                        default:
                            ctx.fillStyle = 'rgb(' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ',' + ((intensity * 220) >> 0) + ')';
                            break;
...
var UI = new function () {
    ...
    this.init = function () {
        ...
        function applyBase(n) {
            var str = 'url(img/base' + Control.config.skin + '.png)';
        ...
        g('set_base').onchange = function () {
            var skin = Control.config.skin = this.options.selectedIndex;
            applyBase(skin);
            setCookie('base', skin);
        };
    ...
    g('high_form').onsubmit = function () {
        ...
        for (var i = 2; i >= 0; i--) {
            if (Game.mode < 3 && score > best[Game.mode - 1][i][0] || Game.mode == 3 && score < best[2][i][0]) {
                if (i < 2) {
                    best[Game.mode - 1][i + 1][0] = best[Game.mode - 1][i][0];
                    best[Game.mode - 1][i + 1][1] = best[Game.mode - 1][i][1];
                }
            }
            else break;
        }
